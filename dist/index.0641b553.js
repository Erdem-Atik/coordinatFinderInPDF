...
const pdfjsLib = require("bdeb9463bd8aab2f");
...
},{"./latLongToDec.js":"e81NR","bdeb9463bd8aab2f":"5JCjp"}],"e81NR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "parseLatLong", ()=>parseLatLong);
function parseLatLong(input) {
    if (!(input.toUpperCase() != input.toLowerCase())) return `${input}:the coordinate already seems as decimal or not valid format`;
...
},{}],"5JCjp":[function(require,module,exports) {
var Buffer = require("a5f1d36e270fecbe").Buffer;
var process = require("f7f56b00151144cb");
/**
    ...
    return /******/ (()=>{
        ...
        /******/ var __webpack_modules__ = [
            ...
            /* 1 */ /***/ (__unused_webpack_module, exports)=>{
                    ...
                    try {
                        if (options && typeof url === "string") {
                            if (options.addDefaultProtocol && url.startsWith("www.")) {
                                ...
                                if (dots && dots.length >= 2) url = `http://${url}`;
                            }
                ...
                function bytesToString(bytes) {
                    if (typeof bytes !== "object" || bytes === null || bytes.length === undefined) unreachable("Invalid argument for bytesToString");
                ...
                function arraysToBytes(arr) {
                    ...
                    let resultLength = 0;
                    for(let i = 0; i < length; i++)resultLength += arrayByteLength(arr[i]);
                    let pos = 0;
                    const data = new Uint8Array(resultLength);
                    for(let i1 = 0; i1 < length; i1++){
                        let item = arr[i1];
                        if (!(item instanceof Uint8Array)) {
                            if (typeof item === "string") item = stringToBytes(item);
                            else item = new Uint8Array(item);
                        }
            ...
            /* 2 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                function getDocument(src) {
                    ...
                    let source;
                    if (typeof src === "string" || src instanceof URL) source = {
                        url: src
                    };
                    else if ((0, _util.isArrayBuffer)(src)) source = {
                        data: src
                    };
                    else if (src instanceof PDFDataRangeTransport) source = {
                        range: src
                    };
                    else {
                        if (typeof src !== "object") throw new Error("Invalid parameter in getDocument, need either string, URL, TypedArray, or parameter object.");
                    ...
                    for(const key in source){
                        ...
                        switch(key){
                            ...
                            case "worker":
                                ...
                                continue;
                            case "data":
                                if (_is_node.isNodeJS && typeof Buffer !== "undefined" && value instanceof Buffer) params[key] = new Uint8Array(value);
                                else if (value instanceof Uint8Array) break;
                                else if (typeof value === "string") params[key] = (0, _util.stringToBytes)(value);
                                else if (typeof value === "object" && value !== null && !isNaN(value.length)) params[key] = new Uint8Array(value);
                                else if ((0, _util.isArrayBuffer)(value)) params[key] = new Uint8Array(value);
                                else throw new Error("Invalid PDF binary data: either TypedArray, string, or array-like object is expected in the data property.");
                                continue;
                        }
                        params[key] = value;
                    }
                    ...
                    if (!Number.isInteger(params.rangeChunkSize) || params.rangeChunkSize < 1) params.rangeChunkSize = DEFAULT_RANGE_CHUNK_SIZE;
                    ...
                    if (typeof params.isOffscreenCanvasSupported !== "boolean") params.isOffscreenCanvasSupported = !_is_node.isNodeJS;
                    ...
                    worker.promise.then(function() {
                        ...
                        const networkStreamPromise = new Promise(function(resolve) {
                            ...
                            else if (!params.data) networkStream = createPDFNetworkStream({
                                url: params.url,
                                length: params.length,
                ...
                async function _fetchDocument(worker, source, pdfDataRangeTransport, docId) {
                    ...
                    if (source.data) source.data = null;
                    if (worker.destroyed) throw new Error("Worker was destroyed");
                    return workerId;
                }
                ...
                class PDFPageProxy {
                    ...
                    render({ canvasContext , viewport , intent ="display" , annotationMode =_util.AnnotationMode.ENABLE , transform =null , canvasFactory =null , background =null , optionalContentConfigPromise =null , annotationCanvasMap =null , pageColors =null , printAnnotationStorage =null  }) {
                        ...
                        const complete = (error)=>{
                            ...
                            if (this.cleanupAfterRender || intentPrint) this.pendingCleanup = true;
                            this._tryCleanup();
                            if (error) {
                    ...
                    _tryCleanup(resetStats = false) {
                        ...
                        this.objs.clear();
                        if (resetStats && this._stats) this._stats = new _display_utils.StatTimer();
                        for (const bitmap of this._bitmaps)bitmap.close();
                        this._bitmaps.clear();
                        this.pendingCleanup = false;
                        return true;
                ...
                class PDFWorker {
                    ...
                    constructor({ name =null , port =null , verbosity =(0, _util.getVerbosityLevel)()  } = {}){
                        if (port && PDFWorker.#workerPorts.has(port)) throw new Error("Cannot use more than one PDFWorker per port.");
                        this.name = name;
                        this.destroyed = false;
                    ...
                    static get workerSrc() {
                        ...
                        if (PDFWorkerUtil.fallbackWorkerSrc !== null) {
                            if (!_is_node.isNodeJS) (0, _display_utils.deprecated)('No "GlobalWorkerOptions.workerSrc" specified.');
                ...
                class WorkerTransport {
                    ...
                    destroy() {
                        ...
                        if (this._passwordCapability) this._passwordCapability.reject(new Error("Worker was destroyed during onPassword callback"));
                        const waitOn = [];
                        ...
                        Promise.all(waitOn).then(()=>{
                            ...
                            if (this._networkStream) this._networkStream.cancelAllRequests(new _util.AbortException("Worker was terminated."));
                        ...
                        messageHandler.on("PasswordRequest", (exception)=>{
                            ...
                            if (loadingTask.onPassword) {
                                const updatePassword = (password)=>{
                                    if (password instanceof Error) this._passwordCapability.reject(password);
                                    else this._passwordCapability.resolve({
                                        password
                                    });
                                };
                                try {
                            ...
                            } else this._passwordCapability.reject(new _util.PasswordException(exception.message, exception.code));
                        ...
                        messageHandler.on("commonobj", ([id, type, exportedData])=>{
                            ...
                            switch(type){
                                case "Font":
                                    ...
                                    if (params.pdfBug && globalThis.FontInspector?.enabled) fontRegistry = {
                ...
                class PDFObjects {
                    ...
                    get(objId, callback = null) {
                        ...
                        const obj1 = this.#objs[objId];
                        if (!obj1?.capability.settled) throw new Error(`Requesting object that isn't resolved yet ${objId}.`);
                        return obj1.data;
                    }
                    has(objId) {
                        const obj = this.#objs[objId];
                ...
                class AnnotationStorage {
                    ...
                    get serializable() {
                        ...
                        for (const [key, val] of this.#storage){
                            ...
                            if (serialized) clone.set(key, serialized);
                        }
                        return clone;
                    }
                    static getHash(map) {
                        ...
                        for (const [key, val] of map)hash.update(`${key}:${JSON.stringify(val)}`);
            ...
            /* 4 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class AnnotationEditor {
                    ...
                    focusin(event) {
                        if (!this.#hasBeenSelected) this.parent.setSelected(this);
                        else this.#hasBeenSelected = false;
                    }
                    focusout(event) {
                    ...
                    fixDims() {
                        ...
                        const [parentWidth, parentHeight] = this.parentDimensions;
                        if (!widthPercent) style.width = `${100 * parseFloat(width) / parentWidth}%`;
            ...
            /* 5 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class KeyboardManager {
                    constructor(callbacks){
                        ...
                        const { isMac  } = _util.FeatureTest.platform;
                        for (const [keys, callback] of callbacks)for (const key of keys){
                ...
                class AnnotationEditorUIManager {
                    ...
                    copy(event) {
                        event.preventDefault();
                        if (this.#activeEditor) this.#activeEditor.commitOrRemove();
                        if (!this.hasSelection) return;
                        const editors = [];
                        for (const editor of this.#selectedEditors)if (!editor.isEmpty()) editors.push(editor.serialize());
                    ...
                    paste(event) {
                        ...
                        try {
                            ...
                            (0, _util.warn)(`paste: "${ex1.message}".`);
                        }
                    }
                    keydown(event) {
                    ...
                    #dispatchUpdateStates(details) {
                        ...
                        if (hasChanged) this.#eventBus.dispatch("annotationeditorstateschanged", {
                            source: this,
                    ...
                    #disableAll() {
                        ...
                        if (this.#isEnabled) {
                            ...
                            for (const layer1 of this.#allLayers.values())layer1.disable();
                        }
                    }
                    ...
                    #addEditorToLayer(editor) {
                        ...
                        if (layer2) layer2.addOrRebuild(editor);
                    ...
                    #isEmpty() {
                        ...
                        if (this.#allEditors.size === 1) {
                            for (const editor1 of this.#allEditors.values())return editor1.isEmpty();
                        }
                        return false;
                    }
                    delete() {
                    ...
                    #selectEditors(editors) {
                        ...
                        for (const editor2 of editors){
                            if (editor2.isEmpty()) continue;
                            this.#selectedEditors.add(editor2);
                            editor2.select();
                        }
                        this.#dispatchUpdateStates({
                            hasSelectedEditor: true
            ...
            /* 6 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class StatTimer {
                    ...
                    toString() {
                        ...
                        for (const { name: name1 , start , end  } of this.times)outBuf.push(`${name1.padEnd(longest)} ${end - start}ms\n`);
                        return outBuf.join("");
                    }
                }
            ...
            /* 8 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class MurmurHash3_64 {
                    ...
                    update(input) {
                        ...
                        for(let i1 = 0; i1 < blockCounts; i1++)if (i1 & 1) {
                            k1 = dataUint32[i1];
            ...
            /* 9 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class FontLoader {
                    ...
                    get isSyncFontLoadingSupported() {
                        let supported = false;
                        if (_is_node.isNodeJS) supported = true;
            ...
            /* 11 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                function drawImageAtIntegerCoords(ctx, srcImg, srcX, srcY, srcW, srcH, destX, destY, destW, destH) {
                    ...
                    if (a === 0 && d === 0) {
                        const tlX1 = destY * c + tx;
                        const rTlX1 = Math.round(tlX1);
                        const tlY1 = destX * b + ty;
                        const rTlY1 = Math.round(tlY1);
                        const brX1 = (destY + destH) * c + tx;
                        const rWidth1 = Math.abs(Math.round(brX1) - rTlX1) || 1;
                        const brY1 = (destX + destW) * b + ty;
                        const rHeight1 = Math.abs(Math.round(brY1) - rTlY1) || 1;
                        ctx.setTransform(0, Math.sign(b), Math.sign(c), 0, rTlX1, rTlY1);
                        ctx.drawImage(srcImg, srcX, srcY, srcW, srcH, 0, 0, rHeight1, rWidth1);
                        ctx.setTransform(a, b, c, d, tx, ty);
                        return [
                            rHeight1,
                            rWidth1
                ...
                function putBinaryImageData(ctx, imgData, transferMaps = null) {
                    ...
                    if (transferMaps) switch(transferMaps.length){
                        case 1:
                    ...
                    if (imgData.kind === _util.ImageKind.GRAYSCALE_1BPP) {
                        ...
                        if (transferMapGray) {
                            if (transferMapGray[0] === 0xff && transferMapGray[0xff] === 0) [white, black] = [
                                black,
                                white
                            ];
                        }
                        ...
                        for(i = 0; i < fullChunks; i++){
                            ...
                            if (hasTransferMaps) for(let k1 = 0; k1 < elemsInThisChunk; k1 += 4){
                                if (transferMapRed) dest[k1 + 0] = transferMapRed[dest[k1 + 0]];
                                if (transferMapGreen) dest[k1 + 1] = transferMapGreen[dest[k1 + 1]];
                                if (transferMapBlue) dest[k1 + 2] = transferMapBlue[dest[k1 + 2]];
                            }
                        ...
                        if (i < totalChunks) {
                            ...
                            dest.set(src.subarray(srcPos, srcPos + elemsInThisChunk));
                            if (hasTransferMaps) for(let k2 = 0; k2 < elemsInThisChunk; k2 += 4){
                                if (transferMapRed) dest[k2 + 0] = transferMapRed[dest[k2 + 0]];
                                if (transferMapGreen) dest[k2 + 1] = transferMapGreen[dest[k2 + 1]];
                                if (transferMapBlue) dest[k2 + 2] = transferMapBlue[dest[k2 + 2]];
                            }
                            ctx.putImageData(chunkImgData, 0, j);
                        }
                    } else if (imgData.kind === _util.ImageKind.RGB_24BPP) {
                        const hasTransferMaps1 = !!(transferMapRed || transferMapGreen || transferMapBlue);
                        ...
                        for(i = 0; i < totalChunks; i++){
                            ...
                            if (hasTransferMaps1) for(let k3 = 0; k3 < destPos; k3 += 4){
                                if (transferMapRed) dest[k3 + 0] = transferMapRed[dest[k3 + 0]];
                                if (transferMapGreen) dest[k3 + 1] = transferMapGreen[dest[k3 + 1]];
                                if (transferMapBlue) dest[k3 + 2] = transferMapBlue[dest[k3 + 2]];
                            }
                            ctx.putImageData(chunkImgData, 0, i * FULL_CHUNK_HEIGHT);
                        }
                ...
                function genericComposeSMask(maskCtx, layerCtx, width, height, subtype, backdrop, transferMap, layerOffsetX, layerOffsetY, maskOffsetX, maskOffsetY) {
                    ...
                    let composeFn;
                    if (subtype === "Luminosity") composeFn = composeSMaskLuminosity;
                    else composeFn = composeSMaskAlpha;
                ...
                class CanvasGraphics {
                    ...
                    beginDrawing({ transform , viewport , transparency =false , background =null  }) {
                        ...
                        if (this.foregroundColor && this.backgroundColor) {
                            ...
                            if (fg === "#000000" && bg === "#ffffff" || fg === bg || !isValidDefaultBg) this.foregroundColor = this.backgroundColor = null;
                            else {
                    ...
                    _createMaskCanvas(img) {
                        ...
                        const offsetX1 = Math.min(cord1[0], cord2[0]);
                        const offsetY1 = Math.min(cord1[1], cord2[1]);
                        fillCtx.translate(-offsetX1, -offsetY1);
                    ...
                    setLineWidth(width) {
                        if (width !== this.current.lineWidth) this._cachedScaleForStroking = null;
                    ...
                    showText(glyphs) {
                        ...
                        for(i = 0; i < glyphsLength; ++i){
                            const glyph1 = glyphs[i];
                            if (typeof glyph1 === "number") {
                                x += spacingDir * glyph1 * fontSize / 1000;
                                continue;
                            }
                            let restoreNeeded = false;
                            const spacing = (glyph1.isSpace ? wordSpacing : 0) + charSpacing;
                            const character = glyph1.fontChar;
                            const accent = glyph1.accent;
                            let scaledX, scaledY;
                            let width1 = glyph1.width;
                            if (vertical) {
                                const vmetric = glyph1.vmetric || defaultVMetrics;
                                const vx = -(glyph1.vmetric ? vmetric[1] : width1 * 0.5) * widthAdvanceScale;
                                const vy = vmetric[2] * widthAdvanceScale;
                                width1 = vmetric ? -vmetric[0] : width1;
                            ...
                            if (font.remeasure && width1 > 0) {
                                const measuredWidth = ctx.measureText(character).width * 1000 / fontSize * fontSizeScale;
                                if (width1 < measuredWidth && this.isFontSubpixelAAEnabled) {
                                    const characterScaleX = width1 / measuredWidth;
                                    restoreNeeded = true;
                                    ctx.save();
                                    ctx.scale(characterScaleX, 1);
                                    scaledX /= characterScaleX;
                                } else if (width1 !== measuredWidth) scaledX += (width1 - measuredWidth) / 2000 * fontSize / fontSizeScale;
                            }
                            if (this.contentVisible && (glyph1.isInFont || font.missingFile)) {
                            ...
                            let charWidth;
                            if (vertical) charWidth = width1 * widthAdvanceScale - spacing * fontDirection;
                            else charWidth = width1 * widthAdvanceScale + spacing * fontDirection;
                            x += charWidth;
                    ...
                    paintInlineImageXObject(imgData) {
                        ...
                        let imgToPaint;
                        if (typeof HTMLElement === "function" && imgData instanceof HTMLElement || !imgData.data) imgToPaint = imgData;
                        else {
                    ...
                    getScaleForStroking() {
                        if (!this._cachedScaleForStroking) {
                            ...
                            if (m[1] === 0 && m[2] === 0) {
                                ...
                                const absDet = Math.abs(m[0] * m[3] - m[2] * m[1]);
                                const normX1 = Math.hypot(m[0], m[1]);
                                const normY1 = Math.hypot(m[2], m[3]);
                                if (lineWidth === 0) {
                                    scaleX = normY1 / absDet;
                                    scaleY = normX1 / absDet;
                                } else {
                                    const baseArea = lineWidth * absDet;
                                    scaleX = normY1 > baseArea ? normY1 / baseArea : 1;
                                    scaleY = normX1 > baseArea ? normX1 / baseArea : 1;
                                }
                            }
            ...
            /* 12 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                function applyBoundingBox(ctx, bbox) {
                    if (!bbox || _is_node.isNodeJS) return;
                    const width = bbox[2] - bbox[0];
                    const height = bbox[3] - bbox[1];
            ...
            /* 13 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                function applyMaskImageData({ src , srcPos =0 , dest , destPos =0 , width , height , inverseDecode =false  }) {
                    ...
                    for(let i = 0; i < height; i++){
                        ...
                        const elem1 = srcPos < srcLength ? src[srcPos++] : 255;
                        for(let j = 0; j < widthRemainder; j++)dest[destPos++] = elem1 & 1 << 7 - j ? oneMapping : zeroMapping;
                    }
                    return {
                        srcPos,
                        destPos
            ...
            /* 17 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class OptionalContentConfig {
                    ...
                    constructor(data){
                        ...
                        if (data.baseState === "OFF") for (const group1 of this.#groups.values())group1._setVisible(INTERNAL, false);
                    ...
                    isVisible(group) {
                        ...
                        if (group.type === "OCG") {
                            ...
                            if (!group.policy || group.policy === "AnyOn") {
                                ...
                                for (const id1 of group.ids){
                                    if (!this.#groups.has(id1)) {
                                        (0, _util.warn)(`Optional content group not found: ${id1}`);
                                        return true;
                                    }
                                    if (!this.#groups.get(id1).visible) return false;
                                }
                                return true;
                            } else if (group.policy === "AnyOff") {
                                for (const id2 of group.ids){
                                    if (!this.#groups.has(id2)) {
                                        (0, _util.warn)(`Optional content group not found: ${id2}`);
                                        return true;
                                    }
                                    if (!this.#groups.get(id2).visible) return true;
                                }
                                return false;
                            } else if (group.policy === "AllOff") {
                                for (const id3 of group.ids){
                                    if (!this.#groups.has(id3)) {
                                        (0, _util.warn)(`Optional content group not found: ${id3}`);
                                        return true;
                                    }
                                    if (this.#groups.get(id3).visible) return false;
                                }
                                return true;
                            }
                    ...
                    _onReceiveData(args) {
                        ...
                        if (args.begin === undefined) {
                            ...
                            const found = this._rangeReaders.some(function(rangeReader) {
                                if (rangeReader._begin !== args.begin) return false;
            ...
            /***/ },
            /* 19 */ /***/ (__unused_webpack_module, exports)=>{
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
            ...
            /* 20 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                const fetchData = function(url) {
                    return new Promise((resolve, reject)=>{
                        const fs = require("7d2ab7343d194ae3");
                ...
                class NodeCanvasFactory extends _base_factory.BaseCanvasFactory {
                    _createCanvas(width, height) {
                        const Canvas = require("e287148666033750");
            ...
            /* 21 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                function getAscent(fontFamily, isOffscreenCanvasSupported) {
                    ...
                    ascent = 0;
                    for(let i1 = 0, ii = pixels.length; i1 < ii; i1 += 4)if (pixels[i1] > 0) {
                        ascent = DEFAULT_FONT_SIZE - Math.floor(i1 / 4 / DEFAULT_FONT_SIZE);
                        break;
                    }
                    ctx.canvas.width = ctx.canvas.height = 0;
                    if (ascent) {
                        const ratio1 = ascent / (ascent + descent);
                        ascentCache.set(fontFamily, ratio1);
                        return ratio1;
                    }
            ...
            /* 22 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class AnnotationEditorLayer {
                    ...
                    enable() {
                        ...
                        for (const editor of this.#editors.values())editor.enableEditing();
                    }
                    disable() {
                        this.div.style.pointerEvents = "none";
                        for (const editor of this.#editors.values())editor.disableEditing();
                    }
                    setActiveEditor(editor) {
                    ...
                    remove(editor) {
                        ...
                        setTimeout(()=>{
                            ...
                            if (document.activeElement === document.body) this.#uiManager.focusMainContainer();
                        }, 0);
                    ...
                    destroy() {
                        if (this.#uiManager.getActive()?.parent === this) this.#uiManager.setActiveEditor(null);
                    ...
                    #cleanup() {
                        ...
                        for (const editor2 of this.#editors.values())if (editor2.isEmpty()) editor2.remove();
                ...
                class FreeTextEditor extends _editor.AnnotationEditor {
                    ...
                    #setEditorDimensions() {
                        ...
                        if (this.isAttachedToDOM) rect = this.div.getBoundingClientRect();
                            ...
                            const { currentLayer , div: div1  } = this;
                            const savedDisplay = div1.style.display;
                            div1.style.display = "hidden";
                            currentLayer.div.append(this.div);
                            rect = div1.getBoundingClientRect();
                            div1.remove();
                            div1.style.display = savedDisplay;
                        }
            ...
            /* 24 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class InkEditor extends _editor.AnnotationEditor {
                    ...
                    #setStroke() {
                        const { ctx , color: color1 , opacity: opacity1 , thickness: thickness1 , parentScale , scaleFactor  } = this;
                        ctx.lineWidth = thickness1 * parentScale / scaleFactor;
                        ctx.lineCap = "round";
                        ctx.lineJoin = "round";
                        ctx.miterLimit = 10;
                        ctx.strokeStyle = `${color1}${(0, _tools.opacityToHex)(opacity1)}`;
                    }
                    #startDrawing(x, y) {
                        this.isEditing = true;
                        ...
                        this.#requestFrameCallback = ()=>{
                            if (!this.#requestFrameCallback) return;
                            if (this.#lastPoint) {
                                if (this.isEmpty()) {
                                    this.ctx.setTransform(1, 0, 0, 1, 0, 0);
                    ...
                    #stopDrawing(x2, y2) {
                        ...
                        if (x2 !== lastX1 || y2 !== lastY1) this.currentPath.push([
                            x2,
                            y2
                        ]);
                        let bezier;
                        if (this.currentPath.length !== 1) bezier = (0, _pdfjsFitCurve.fitCurve)(this.currentPath, 30, null);
                        else {
                            const xy = [
                                x2,
                                y2
                    ...
                    #redraw() {
                        ...
                        this.#setStroke();
                        const { canvas , ctx: ctx1  } = this;
                        ctx1.setTransform(1, 0, 0, 1, 0, 0);
                        ctx1.clearRect(0, 0, canvas.width, canvas.height);
                        this.#updateTransform();
                        for (const path of this.bezierPath2D)ctx1.stroke(path);
                    }
                    commit() {
                    ...
                    #setScaleFactor(width1, height1) {
                        const padding = this.#getPadding();
                        const scaleFactorW = (width1 - padding) / this.#baseWidth;
                        const scaleFactorH = (height1 - padding) / this.#baseHeight;
                    ...
                    static #buildPath2D(bezier1) {
                        ...
                        for(let i = 0, ii = bezier1.length; i < ii; i++){
                            const [first, control1, control2, second] = bezier1[i];
                            if (i === 0) path2D1.moveTo(...first);
                            path2D1.bezierCurveTo(control1[0], control1[1], control2[0], control2[1], second[0], second[1]);
                        }
                        return path2D1;
                    }
                    #serializePaths(s, tx, ty, h) {
                        ...
                        for (const bezier2 of this.paths){
                            buffer = [];
                            points = [];
                            for(let i1 = 0, ii1 = bezier2.length; i1 < ii1; i1++){
                                const [first1, control11, control21, second1] = bezier2[i1];
                                const p10 = s * (first1[0] + tx) + padding2;
                                const p11 = h - s * (first1[1] + ty) - padding2;
                                const p20 = s * (control11[0] + tx) + padding2;
                                const p21 = h - s * (control11[1] + ty) - padding2;
                                const p30 = s * (control21[0] + tx) + padding2;
                                const p31 = h - s * (control21[1] + ty) - padding2;
                                const p40 = s * (second1[0] + tx) + padding2;
                                const p41 = h - s * (second1[1] + ty) - padding2;
                                if (i1 === 0) {
                                    buffer.push(p10, p11);
                                    points.push(p10, p11);
                                }
                    ...
                    #extractPointsOnBezier(p101, p111, p201, p211, p301, p311, p401, p411, n, points1) {
                        if (this.#isAlmostFlat(p101, p111, p201, p211, p301, p311, p401, p411)) {
                        ...
                        for(let i2 = 1; i2 < n - 1; i2++){
                            const t = i2 / n;
                            const mt = 1 - t;
                            let q10 = t * p101 + mt * p201;
                            let q11 = t * p111 + mt * p211;
                            let q20 = t * p201 + mt * p301;
                            let q21 = t * p211 + mt * p311;
                            const q30 = t * p301 + mt * p401;
                            const q31 = t * p311 + mt * p411;
                            q10 = t * q10 + mt * q20;
                            q11 = t * q11 + mt * q21;
                            q20 = t * q20 + mt * q30;
                            q21 = t * q21 + mt * q31;
                            q10 = t * q10 + mt * q20;
                            q11 = t * q11 + mt * q21;
                            points1.push(q10, q11);
                        }
                        points1.push(p401, p411);
                    }
                    #isAlmostFlat(p102, p112, p202, p212, p302, p312, p402, p412) {
                        const tol = 10;
                        const ax = (3 * p202 - 2 * p102 - p402) ** 2;
                        const ay = (3 * p212 - 2 * p112 - p412) ** 2;
                        const bx = (3 * p302 - p102 - 2 * p402) ** 2;
                        const by = (3 * p312 - p112 - 2 * p412) ** 2;
                    ...
                    #getBbox() {
                        ...
                        let yMin = Infinity;
                        let yMax = -Infinity;
                        for (const path1 of this.paths)for (const [first2, control12, control22, second2] of path1){
                            const bbox = _util.Util.bezierBoundingBox(...first2, ...control12, ...control22, ...second2);
                    ...
                    #fitToContent(firstTime = false) {
                        ...
                        const padding3 = this.#getPadding();
                        this.#baseWidth = Math.max(RESIZER_SIZE, bbox1[2] - bbox1[0]);
                        this.#baseHeight = Math.max(RESIZER_SIZE, bbox1[3] - bbox1[1]);
                        const width2 = Math.ceil(padding3 + this.#baseWidth * this.scaleFactor);
                        const height2 = Math.ceil(padding3 + this.#baseHeight * this.scaleFactor);
                        const [parentWidth1, parentHeight1] = this.parentDimensions;
                        this.width = width2 / parentWidth1;
                        this.height = height2 / parentHeight1;
                        this.#aspectRatio = width2 / height2;
                        this.#setMinDims();
                        ...
                        this.#realHeight = height2;
                        this.setDims(width2, height2);
                        const unscaledPadding = firstTime ? padding3 / this.scaleFactor / 2 : 0;
            ...
            /***/ },
            /* 25 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
            ...
            /* 26 */ /***/ (module1)=>{
                function fitCurve(points, maxError, progressCallback) {
                    ...
                    points.forEach((point)=>{
                        if (!Array.isArray(point) || point.some((item)=>typeof item !== "number") || point.length !== points[0].length) throw Error("Each point should be an array of numbers. Each point should have the same amount of numbers.");
                    });
                ...
                function fitCubic(points, leftTangent, rightTangent, error, progressCallback) {
                    ...
                    if (maxError === 0 || maxError < error) return [
                        bezCurve
                    ];
            ...
            /* 27 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class AnnotationElement {
                    ...
                    _createContainer(ignoreBorder = false) {
                        ...
                        if (!ignoreBorder && data.borderStyle.width > 0) {
                            ...
                            if (horizontalRadius > 0 || verticalRadius > 0) {
                                ...
                                const radius1 = `calc(${width}px * var(--scale-factor)) / calc(${height}px * var(--scale-factor))`;
                                container.style.borderRadius = radius1;
                            }
                            ...
                            if (borderColor) container.style.borderColor = _util.Util.makeHexColor(borderColor[0] | 0, borderColor[1] | 0, borderColor[2] | 0);
                    ...
                    get _commonActions() {
                        ...
                        return (0, _util.shadow)(this, "_commonActions", {
                            ...
                            readonly: (event)=>{
                                if (event.detail.readonly) event.target.setAttribute("readonly", "");
                                else event.target.removeAttribute("readonly");
                            },
                            required: (event)=>{
                    ...
                    _renderQuadrilaterals(className) {
                        for (const quadrilateral of this.quadrilaterals)quadrilateral.className = className;
                    ...
                    _getElementsByName(name, skipId = null) {
                        ...
                        for (const domElement1 of document.getElementsByName(name)){
                            const { exportValue: exportValue1  } = domElement1;
                            const id1 = domElement1.getAttribute("data-element-id");
                            if (id1 === skipId) continue;
                            if (!GetElementsByNameSet.has(domElement1)) continue;
                            fields.push({
                                id: id1,
                ...
                class LinkAnnotationElement extends AnnotationElement {
                    ...
                    render() {
                        ...
                        if (this.quadrilaterals) return this._renderQuadrilaterals("linkAnnotation").map((quadrilateral, index)=>{
                        ...
                        link.onclick = ()=>{
                            ...
                            if (resetFormFields.length !== 0 || resetFormRefs.length !== 0) {
                                ...
                                for (const fields1 of Object.values(this._fieldObjects)){
                                    for (const field of fields1)if (fieldIds.has(field.id) === include) allFields.push(field);
                                }
                            } else for (const fields2 of Object.values(this._fieldObjects))allFields.push(...fields2);
                            ...
                            for (const field1 of allFields){
                                ...
                                switch(field1.type){
                                    case "text":
                                        {
                                            const value = field1.defaultValue || "";
                                            storage.setValue(id1, {
                                                value
                                            });
                                            break;
                                        }
                                    ...
                                    case "listbox":
                                        {
                                            const value2 = field1.defaultValue || "";
                                            storage.setValue(id1, {
                                                value: value2
                                            });
                                            break;
                                ...
                                const domElement = document.querySelector(`[data-element-id="${id1}"]`);
                                if (!domElement) continue;
                                else if (!GetElementsByNameSet.has(domElement)) {
                                    (0, _util.warn)(`_bindResetFormAction - element not allowed: ${id1}`);
                                    continue;
                                }
                ...
                class WidgetAnnotationElement extends AnnotationElement {
                    ...
                    _setEventListeners(element, names, getter) {
                        for (const [baseName, eventName] of names)if (eventName === "Action" || this.data.actions?.[eventName]) this._setEventListener(element, baseName, eventName, getter);
                    }
                    ...
                    _setTextStyle(element) {
                        ...
                        if (this.data.multiLine) {
                            ...
                            const height1 = Math.abs(this.data.rect[3] - this.data.rect[1] - BORDER_SIZE);
                            computedFontSize = Math.min(fontSize, roundToOneDecimal(height1 / _util.LINE_FACTOR));
                        }
                                ...
                                if (this.data.actions?.Keystroke) element.addEventListener("beforeinput", (event)=>{
                                    ...
                                    switch(event.inputType){
                                        ...
                                        case "deleteWordForward":
                                            {
                                                const match1 = value.substring(selectionStart).match(/^[^\w]*\w*/);
                                                if (match1) selEnd += match1[0].length;
                                                break;
                                            }
                ...
                class PopupAnnotationElement extends AnnotationElement {
                    ...
                    render() {
                        ...
                        if (parentElements.length === 0) return this.container;
                ...
                class PopupElement {
                    ...
                    render() {
                        ...
                        if (!Array.isArray(this.trigger)) this.trigger = [
                            this.trigger
                        ];
                    ...
                    _toggle() {
                        if (this.pinned) this._hide(true);
                ...
                class FileAttachmentAnnotationElement extends AnnotationElement {
                    ...
                    render() {
                        ...
                        let trigger;
                        if (this.data.hasAppearance) trigger = document.createElement("div");
                        else {
                ...
                class AnnotationLayer {
                    ...
                    static render(params) {
                        ...
                        for (const data of annotations){
                            ...
                            if (Array.isArray(rendered)) for (const renderedElement of rendered){
                                renderedElement.style.zIndex = zIndex++;
                                AnnotationLayer.#appendElement(renderedElement, data.id, div, accessibilityManager);
                            }
                            else {
                                rendered.style.zIndex = zIndex++;
                                if (element instanceof PopupAnnotationElement) div.prepend(rendered);
                                else AnnotationLayer.#appendElement(rendered, data.id, div, accessibilityManager);
                            }
                        }
                    ...
                    static #setAnnotationCanvasMap(div1, annotationCanvasMap) {
                        if (!annotationCanvasMap) return;
                        for (const [id1, canvas] of annotationCanvasMap){
                            const element1 = div1.querySelector(`[data-annotation-id="${id1}"]`);
                            if (!element1) continue;
                            const { firstChild  } = element1;
                            if (!firstChild) element1.append(canvas);
                ...
                class XfaLayer {
                    ...
                    static render(parameters) {
                        ...
                        while(stack.length > 0){
                            ...
                            let childHtml;
                            if (child?.attributes?.xmlns) childHtml = document.createElementNS(child.attributes.xmlns, name);
                            else childHtml = document.createElement(name);
                            ...
                            if (child.children && child.children.length > 0) stack.push([
                                ...
                                const node1 = document.createTextNode(child.value);
                                if (_xfa_text.XfaText.shouldBuildText(name)) textDivs.push(node1);
                                childHtml.append(node1);
                            }
                        }
            ...
            /***/ },
            /* 30 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
                ...
                exports.SVGGraphics = SVGGraphics;
                {
                    ...
                    const convertImgDataToPng = function() {
                        ...
                        for(let i = 0; i < 256; i++){
                            let c = i;
                            for(let h = 0; h < 8; h++)if (c & 1) c = 0xedb88320 ^ c >> 1 & 0x7fffffff;
                        ...
                        function deflateSync(literals) {
                            if (!_is_node.isNodeJS) return deflateSyncUncompressed(literals);
                            try {
                                let input;
                                if (parseInt(process.versions.node) >= 8) input = literals;
                                else input = Buffer.from(literals);
                                const output = require("ffecdc90c7371f4f").deflateSync(input, {
                                    level: 9
                                });
                    ...
                    function pm(m) {
                        if (m[4] === 0 && m[5] === 0) {
                            ...
                            if (m[0] === 1 && m[1] === 0 && m[2] === 0 && m[3] === 1) return `translate(${pf(m[4])} ${pf(m[5])})`;
                        }
                    ...
                    exports.SVGGraphics = SVGGraphics = class {
                        ...
                        showText(glyphs) {
                            ...
                            for (const glyph of glyphs){
                                ...
                                let charWidth;
                                if (vertical) charWidth = width * widthAdvanceScale - spacing * fontDirection;
                                else charWidth = width * widthAdvanceScale + spacing * fontDirection;
                                x += charWidth;
                            }
            ...
            /***/ },
            /* 31 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
                ...
                const fs = require("7d2ab7343d194ae3");
                const http = require("7a05df1878b972b9");
                const https = require("6ba30a2d1f6ec75e");
                const url = require("7c012d15295c7c4f");
                ...
                class PDFNodeStreamFullReader extends BaseFullReader {
                    constructor(stream){
                        ...
                        this._request = null;
                        if (this._url.protocol === "http:") this._request = http.request(createRequestOptions(this._url, stream.httpHeaders), handleResponse);
                        else this._request = https.request(createRequestOptions(this._url, stream.httpHeaders), handleResponse);
                ...
                class PDFNodeStreamRangeReader extends BaseRangeReader {
                    constructor(stream, start, end){
                        ...
                        this._request = null;
                        if (this._url.protocol === "http:") this._request = http.request(createRequestOptions(this._url, this._httpHeaders), handleResponse);
                        else this._request = https.request(createRequestOptions(this._url, this._httpHeaders), handleResponse);
                        this._request.on("error", (reason)=>{
                            this._storedError = reason;
                        });
                        this._request.end();
            ...
            /* 33 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                function getFilenameFromContentDispositionHeader(contentDisposition) {
                    ...
                    if (tmp) {
                        const filename1 = rfc2047decode(tmp);
                        return fixupEncoding(filename1);
                    }
                    tmp = toParamRegExp("filename", "i").exec(contentDisposition);
                    if (tmp) {
                        tmp = tmp[1];
                        let filename2 = rfc2616unquote(tmp);
                        filename2 = rfc2047decode(filename2);
                        return fixupEncoding(filename2);
                    }
                    ...
                    function rfc2231getparam(contentDispositionStr) {
                        ...
                        for(let n1 = 0; n1 < matches.length; ++n1){
                            if (!(n1 in matches)) break;
                            let [quot1, part1] = matches[n1];
                            part1 = rfc2616unquote(part1);
                            if (quot1) {
                                part1 = unescape(part1);
                                if (n1 === 0) part1 = rfc5987decode(part1);
                            }
                            parts.push(part1);
                        }
                        return parts.join("");
            ...
            /* 34 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                ...
                class PDFNetworkStreamFullRequestReader {
                    ...
                    _onDone(data) {
                        ...
                        for (const requestCapability1 of this._requests)requestCapability1.resolve({
                            value: undefined,
                            done: true
                        });
                        this._requests.length = 0;
            ...
            /***/ },
            /* 35 */ /***/ (__unused_webpack_module, exports, __w_pdfjs_require__)=>{
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
        ...
        (()=>{
            ...
            if (_is_node.isNodeJS) {
                ...
                (0, _api.setPDFNetworkStreamFactory)((params)=>{
                    if ((0, _display_utils.isValidFetchUrl)(params.url)) return new PDFFetchStream(params);
...
},{"a5f1d36e270fecbe":"fCgem","f7f56b00151144cb":"d5jf4","7d2ab7343d194ae3":"jhUEF","e287148666033750":"jhUEF","ffecdc90c7371f4f":"jhUEF","7a05df1878b972b9":"jhUEF","6ba30a2d1f6ec75e":"jhUEF","7c012d15295c7c4f":"jhUEF"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("5108ef060ae3f5e7");
var ieee754 = require("3a5f3e93cd333fdb");
...
},{"5108ef060ae3f5e7":"eIiSV","3a5f3e93cd333fdb":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{}]},["7Aums","bNKaB"], "bNKaB", "parcelRequiree10a")
